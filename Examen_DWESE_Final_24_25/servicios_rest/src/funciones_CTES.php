...
function horarioGrupo($id_grupo)
{
    ...
    try{
        $consulta="select horario_lectivo.dia, horario_lectivo.hora, usuarios.nombre as usuarios, aulas.nombre as aula from aulas, horario_lectivo, usuarios where horario_lectivo.usuario=usuarios.id_usuario and horario_lectivo.aula = aulas.id_aula and horario_lectivo.grupo = ?";
        $sentencia=$conexion->prepare($consulta);
